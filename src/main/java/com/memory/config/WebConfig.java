...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://localhost:5173","http://localhost:8080","http://15.165.154.126:8080", "https://matameco.shop", "https://memorymeta.vercel.app/", "https://www.metamemory.site/")//자원 공유를 허락할 Origin을 지정
